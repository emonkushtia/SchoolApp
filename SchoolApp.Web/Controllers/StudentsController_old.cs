namespace SchoolApp.Web.Controllers
{
    ...
    [RoutePrefix("api/studentsOld")]
    public class StudentsControllerOld : ApiController
    {
        private readonly IRepositoryService<StudentItem, StudentCreateItem> repositoryService;

        public StudentsControllerOld(IRepositoryService<StudentItem, StudentCreateItem> repositoryService)
        {
